    ...
    if not is_searching:
        ...
        with center_col:
            ...
            html_content = (
                ...
                '">'
                '<li style="margin-bottom:6px;">1. Fauziah Hasanah       (2530614)</li>'
                '<li style="margin-bottom:6px;">2. Nabila Agustin        (2530641)</li>'
                '<li style="margin-bottom:6px;">3. Sarah Siti Shalsabila (2530651)</li>'
                '<li style="margin-bottom:6px;">4. Sirvi Fauziah         (2530653)</li>'
                '<li style="margin-bottom:6px;">5. Sukma Widad Alhana    (2530655)</li>'
                '</ul>'
                '</div>'
            )
