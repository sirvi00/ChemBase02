...
.tim-table td {
  padding: 10px 14px; border-bottom: 1px solid #e2e2e5; color: #1a1c1e; vertical-align: middle;
}
.tim-table tr:last-child td { border-bottom: none; }
.tim-table tr:nth-child(even) td { background: #f9f9fc; }
.tim-table .no-cell {
  font-family: 'JetBrains Mono', monospace; font-weight: 700;
  color: #006591; width: 36px; text-align: center;
}
.tim-table .nim-cell {
  font-family: 'JetBrains Mono', monospace; font-size: 13px;
  color: #6e7882; text-align: right; white-space: nowrap;
}
...
def show_beranda():
    ...
    st.markdown("""
    <div class="info-card">
      <h3>Kelompok · D3 Pengolahan Limbah Industri · Politeknik AKA Bogor</h3>
      <table class="tim-table" style="margin-top:8px">
        <tbody>
          <tr>
            <td class="no-cell">1</td>
            <td>Fauziah Hasanah</td>
            <td class="nim-cell">2530614</td>
          </tr>
          <tr>
            <td class="no-cell">2</td>
            <td>Nabila Agustin</td>
            <td class="nim-cell">2530641</td>
          </tr>
          <tr>
            <td class="no-cell">3</td>
            <td>Sarah Siti Shalsabila</td>
            <td class="nim-cell">2530651</td>
          </tr>
          <tr>
            <td class="no-cell">4</td>
            <td>Sirvi Fauziah</td>
            <td class="nim-cell">2530653</td>
          </tr>
          <tr>
            <td class="no-cell">5</td>
            <td>Sukma Widad Alhana</td>
            <td class="nim-cell">2530655</td>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    if st.session_state.active_page in ("beranda", "search") or is_searching:
        ...
        with nav_col1:
            if st.button(
                ...
                type="primary" if st.session_state.active_page == "beranda" else "secondary",
            ):
                st.session_state.active_page = "beranda"
                st.session_state["q"] = ""
                st.rerun()
        with nav_col2:
            if st.button(
                "🔍 Cari Senyawa",
                use_container_width=True,
                type="primary" if st.session_state.active_page == "search" else "secondary",
            ):
